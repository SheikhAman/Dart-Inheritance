void main (){
  ...
  var aman = Aman();  // Aman() constructor call ba notun object create korlam , aman hoche reference variable
  ...
  var farhad = Farhad(); // Farhad() constructor call ba notun object create korlam , farhad hoche reference variable
  ...
  print(student.semester); // super class a  instance variable r value print korlam
...
class Student{  // super class
 ...
 late String semester; // instance variable or field variable declared
  void coding  (){ // method created
    print('Doing untill i sleep');
  }
  
}
class Aman extends Student{ // child class extends superclass

 late int roll; // instance variable or field variable declared
  void sleep(){ // method created
    print('8 hour sleeping');
    
  }
}
class Farhad extends Student{ // child class extends superclass
 late  int work; // instance variable or field variable declared
  void study(){  // method created
